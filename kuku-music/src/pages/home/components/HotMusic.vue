<template>
  <Row justify="center" align="middle" style="margin-top: 25px">
    <Breadcrumb style="margin-left: 360px">
      <BreadcrumbItem to="/">Home</BreadcrumbItem>
      <BreadcrumbItem>热门歌曲</BreadcrumbItem>
    </Breadcrumb>
  ...
  export default {
    ...
    methods: {
      ...
      loadMusicSearchList() {
        ...
        this.$http.paramsGet('/music/hotMusicPlay', {

          pageNum: (this.pageNum - 1) * this.pageSize,
          pageSize: this.pageSize,
          s: this.searchInput == null ? "rain":this.searchInput,
          type: 1,
        }).then(res => {
          console.log(res)
